    ...
    public function AdminPostCreePartie(creerFormEvaluation $request)
{
    ...
    $part = session()->put('partie', $partie);
    dd($part);
    // Rediriger ou effectuer d'autres actions
    return to_route('AdminBilanPartie');
}
...
public function AdminPostBilanPartie(Request $request)
{
    ...
    $idEvaluation = Partie::where('nom', $partie['nom'])->value('id');
    ...
    public function classes(){
        ...
        foreach ($parties as $key => $partie) {
            $classes[$key] = Evaluclasse::where('partie', $partie)
            ->distinct()
            ->pluck('classe')
            ->toArray();
        }
    ...
    public function classesEvalu($id){
        ...
        $partieIds = Evaluclasse::where('classe',$id)->pluck('partie');
        $parties = [];
        $matieres = [];
        $dates = [];
