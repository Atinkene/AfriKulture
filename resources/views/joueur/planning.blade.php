...
@section('content')
                ...
                <div class="  justify-center items-center mt-3 grid grid-cols-3 grid-row-2 gap-y-10 gap-x-4">
                    @foreach ($planElems as $key=>$plan)
                        <a href="" class="bg-gradient-to-l  from-[#c44241] via-[#c44241] to-[#cf6d60] group hover:bg-none  hover:border-dashed hover:border-2 hover:border-white/60  rounded-3xl  px-14 w-  grid grid-cols-1 gap-y-0 items-center text-center text-white">
