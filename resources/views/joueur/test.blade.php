...
@section('content')
    <div class="mt-10 space-y-8">
        ...
        @endforeach
        <div class="mt-10 flex justify-center w-1/4 m-auto items-center">
            <div id="resultcontainer" class="w-1/2 hidden py-16   justify-center items-center">
                <div class=" p-36 relative ">
                    <div class="z-50 bg-[#40191d;]  top-0 w-full h-full rotate-0 left-0 rounded-full w- absolute  flex justify-center items-center ">
                        <div class="border-dashed border-[#c44241]/45 border-2 p-14 rounded-full grid grid-cols-1">
                            <div class="text-[#c44241]/45 font-semibold text-2xl text-center">Score total</div>
                            <div id="resultat" class="text-white font-semibold text-6xl text-center"></div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            forms.forEach(function(form) {
                form.addEventListener('submit', function(event) {
                    ...
                    .then(data => {
                        ...
                        messageScore.classList.add('flex',  'justify-center', 'items-center', 'w-full', 'italic', 'font-semibold','col-span-2', 'py-2', 'text-lg')
                        ...
                        questionSuivante.addEventListener('click',()=>{
                            ...
                            if (questionSuivante.classList.contains('question-suivante') ) {
            ...
            dernierForm.addEventListener('submit', function(event) {
                ...
                // var scoreTotal = 0;
                // var scores = {}; // Pour stocker les scores individuels des questions visibles
                ...
                .then(data => {
                    ...
                    setTimeout(function() { // Attendre 2 secondes
