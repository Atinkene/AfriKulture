        ...
        <div class="flex  justify-end items-start w-full relative h-screen">
                 ...
                 <div class="relative bg-black bg-opacity-35 h-full py-4 shadow-inner rounded-full w-1/2 text-white">
                    <div class="space-x-4">
                        <a class="" href="/">
                         ...
                         <a class="" href="{{route('partieAvenir')}}">
                             <div  class=" h-10 flex justify-center items-center text-center">
                         ...
                         <a class="" href="{{route('JoueurPlanning')}}">
                             <div  class=" h-10 flex justify-center items-center text-center">
             ...
             <div class="justify-start items-start w-[92%]  h-full py-1 ">
                <div class="p-5 grid grid-cols-1 ">
                    <div class="grid grid-cols-8  text-lg text-white space-x-2">
                        ...
                        <div class=" col-span-4 flex justify-center  items-center">
                            <div class="text-sm space-x-2 flex justify-center rounded-full items-center w-1/2 bg-black/25 px-3">
                                ...
                                <input class="5/6 h-8 bg-transparent w-full rounded-r-full focus:border-transparent focus:outline-none font-none" type="text" name="" id="" placeholder="recherche">
                            </div>
                        </div>
                        <div class=" flex justify-end  items-center">
                            <div class="rounded-full bg-black/35 px-5 relative mr-2">
                                <svg id="notif" class="h-8 w-6 fill-current text-white hover:text-[#c44241]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                  ...
                                  <div id="notification" class="border-2 border-dashed border-[#c44241] hidden z-50 absolute w-[300px] right-1 top-10 backdrop-blur bg-[#c44241]/25 rounded-lg">
                                    <div class="w-11/12 text-md font-none m-auto text-center font-semibold">Nouveaux messages</div>
                                    <div class="w-11/12 text-md font-none m-auto text-center space-y-2 py-3" id="notificationsSection"></div>
                                    @switch(auth()->user()->status)
                        
                                        @case('joueur')
                                        <a class="bg-gradient-to-l rounded-t-3xl hover:from-[#c44241] hover:via-[#c44241] hover:to-[#cf6d60] w-11/12 text-md font-semibold m-auto flex justify-center items-center" href="{{route('joueurNotifications')}}">Toutes les notifications</a>
                                    
                                            @break
                                        @case('admin')
                                        <a class="bg-gradient-to-l rounded-t-3xl hover:from-[#c44241] hover:via-[#c44241] hover:to-[#cf6d60] w-11/12 text-md font-semibold m-auto flex justify-center items-center" href="{{route('adminNotifications')}}">Toutes les notifications</a> 
                                        @break
    ...
    <script>
        ...
        if (data.length === 0) {
            ...
            const notificationsHTML = data.map((notification) => {
                let message = `${notification.data.message}`.slice(0,20);
                console.log(notification);
                return `
                    <a href="${notification.data.url}/${notification.id}" class="py-2 mb-2 text-sm h-56  shadow-inner border-b-2 m-auto hover:border-blue-800 cursor-pointer w-full ">
                        <div class="bg-black/25 hover:bg-gradient-to-l  hover:from-[#c44241] hover:via-[#c44241] hover:to-[#cf6d60] text-sm hover:text-white border-b-2 flexbox hover:border-black/25 rounded-lg ">
                            <div class="font-semibold text-md">${notification.data.titre}</div>
                            <div class="text-sm italic">${message}...</div>
