    ...
    <div class="space-y- ">
        <div class="grid grid-cols-2">
            <div class="text-white h-full relative grid grid-cols-3">
                <div class="col-span-2 relative rounded-3xl flex justify-start items-center h-52 bg-gradient-to-l  from-[#c44241] via-[#c44241] to-[#cf6d60] shadow-inner">
                    <div class="grid grid-cols-1 w-3/4 p-3  bg-">
                        <span class="text-2xl font-bold text-center">Administrateur</span>
                        <span class="text-xs"> joue un rôle crucial en assurant la gestion efficace des parties du jeu, en facilitant une expérience cohérente et engageante pour les utilisateurs qui participent aux différentes activités proposées.</span>
                    </div>
                </div>
            ...
            <div class="h-full grid grid-cols-1 gap-5">
                <div class="p-5 bg-black bg-opacity-35 rounded-3xl"></div>
                <div class="p-5 bg-black bg-opacity-35 rounded-3xl"></div>
                <div class="p-5 bg-black bg-opacity-35 rounded-3xl backdrop-blur"></div>
            </div>
        </div>
                        ...
                        @foreach ($planElems as  $key=> $plan)
                            @if ($key==0)
                                <div class="m-auto h-full w-1/3 rounded-3xl border-dashed border-2 border-white">
                                    <div class="bg-black bg-opacity-35 bg-cover h-full rounded-3xl -rotate-6 text-white" style="background-image: url('/storage/{{$plan->miniature}}')"><div class="bg-[#c44241]/50 font-semibold rounded-t-3xl">{{$plan->nom}}</div></div>
                                </div>
                            @elseif ($key==1) 
                                <div class="m-auto bg-cover bg-black/45 h-full w-1/3 rounded-3xl text-white text-center font-semibold" style="background-image: url('/storage/{{$plan->miniature}}')"><div class="bg-[#c44241]/50 font-semibold rounded-t-3xl">{{$plan->nom}}</div></div>   
                            @elseif($key=2)
                                <div class="m-auto bg-cover bg-black/45 h-full w-1/3 rounded-3xl text-white" style="background-image: url('/storage/{{$plan->miniature}}')"><div class="bg-[#c44241]/50 font-semibold rounded-t-3xl">{{$plan->nom}}</div></div>
                            ...
                            <div class=" bg-gradient-to-r from-[#c44241]/5 via-black/25 to-black/35 h-full w-[98%] grid grid-cols-2 rounded-3xl">
                                <div class="space-x-5 bg-[#c44241] rounded-3xl shadow-inner flex justify-center items-center">
                                    ...
                                    <div class="text-white ">
                                        <div class="font-bold">Massina</div>
                                        <div class="p-2 text-center">
                                                <span class="bg-black/45 p-2 rounded-full text-sm">Intermédiaire</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex justify-center items-center">
                                    <div class="">
                                        ...
                                        <div class="text-white font-semibold text-xl text-center">255</div>
                                    </div>
                                    <div class=""></div>
                                </div>
                            </div>
                ...
                <div class="bg-black bg-opacity-35 w-full h-full rounded-3xl grid grid-cols-1 ">
                        ...
                        <div class=" p-16 relative ">
                            <div class="z-50 bg-[#40191d;]  top-0 w-full h-full rotate-0 left-0 rounded-full w- absolute  flex justify-center items-center ">
                                <div class="border-dashed border-[#c44241]/45 border-2 p-3 rounded-full grid grid-cols-1">
                                    <div class="text-[#c44241]/45 font-semibold text-md text-center">Parties créées</div>
                                    <div class="text-white font-semibold text-2xl text-center">{{$totalPartie}}</div>
                                </div>
                            </div>
                    ...
                    <div class="flex justify-center items-center">
                            <div class="m-auto">
                                ...
                                <div class="text-center font-semibold text-lg text-white/80 ">{{$enattente}}</div>
                            </div>
                            <div class="m-auto">
                            ...
                            <div class="m-auto">
                                ...
                                <div class="text-center font-semibold text-lg text-white/80 ">{{$totalPartieAchevee}}</div>
                            </div>
                    </div>
                </div>
            </div>
