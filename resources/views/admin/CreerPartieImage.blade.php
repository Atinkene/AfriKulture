...
@section('content')
    <div class="">
        <form action="{{route('AdminPostCreePartieImage')}}" method="post" class="" enctype="multipart/form-data">
            @csrf
            ...
            <div class="w-full flex justify-center items-center p-5">
                ...
                <div class="hidden text-[#c44241] text-lg  justify-center items-center m-auto">
                    ...
                    <select name="type" id="">
                        ...
                        <option selected value="image">Image à texte</option>
                        <option  value="text">Texte à texte</option>
                    </select>
                </div>
            </div>
                ...
                <div class="bg-gradient-to-l  from-[#c44241] via-[#c44241] to-[#cf6d60] question shadow-md shadow-[#c44241]/400 rounded-3xl w-full mb-5">
                    <div class="w-full ml-5 text-[#c44241] text-lg p-5 space-x-2 flex justify-center items-center">
                        <div class="w-5/6 text-white">
                            <label class="font-bold" for="">Image 1 : </label>
                            <input class="w-[80%]" name="questions[0][libelle]" type="file"> <br>
                        </div>
            ...
            <div class="flex justify-center items-center p-5">
                <button class="h-8 flex justify-center items-center mb-3 bg-[#c44241] rounded-full p-4 font-bold text-white text-sm" type="button" id="addQuestion">Ajouter une image</button>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function ajouterQuestion() {
            ...
            newQuestion.innerHTML = `
                ...
                <div class="w-full ml-5 text-[#c44241] text-lg p-5 space-x-2 flex justify-center items-center">
                        <div class="w-5/6 text-white">
                            <label class="font-bold" for="">Image ${questionIndex + 1} : </label>
                            <input class="w-[80%]" name="questions[${questionIndex}][libelle]" type="file"> <br>
                        </div>
                        <div class="w-1/6 bg-white rounded-full h-full flex justify-end items-center">
                            <label class="font-bold w-3/5 p-1" for="">Points :</label>
