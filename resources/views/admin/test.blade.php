            ...
            <div id="resultcontainer" class="w-1/2 hidden py-16 justify-center items-center">
                <div class=" p-24 relative ">
                    <div class="z-50 bg-[#40191d]  top-0 w-full h-full rotate-0 left-0 rounded-full w- absolute  flex justify-center items-center ">
                        <div class="border-dashed border-[#c44241]/45 border-2 p-8 rounded-full grid grid-cols-1">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            forms.forEach(function(form, index) {
                form.addEventListener('submit', function(event) {
                    ...
                    .then(data => {
                        ...
                        form.querySelector('.grid').appendChild(messageScore);

                        var nextForm = forms[index + 1];
                        if (nextForm) {
            ...
            function calculateTotalScore() {
                ...
                var url = "{{ route('calculerScoreTotal',[$question->id]) }}";
                ...
                .then(data => {
                    ...
                    resultat.appendChild(messageScoreTotal);
                })
                .catch(error => {
